...
<body>
  ...
  <input type="text" class="form-control" id="singkatan" placeholder="masukan singkatan">
  
  <label for="exampleFormControlInput1" class="form-label">nama dekan fakultas</label>
  <input type="text" class="form-control" id="dekan" placeholder="masukan nama dekan fakultas">
